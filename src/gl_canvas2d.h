...
public:
    ...
    static void circle( float x, float y, float radius, int div, float angulo);
    static void circle( Vector2 pos, float radius, int div, float angulo);

    static void circleFill( float x, float y, float radius, int div, float angulo);
    static void circleFill( Vector2 pos, float radius, int div, float angulo);
